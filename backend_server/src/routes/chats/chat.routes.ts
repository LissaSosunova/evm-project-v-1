...
chatRoutes.delete('/delete_draft_message/:chatID/:authorId', [verifyToken], new DeleteDraftMessageController().delete.bind(new DeleteDraftMessageController()));
chatRoutes.get('/get_draft_message/:chatId', [verifyToken], new GetDraftMessageController().getMessage.bind(new GetDraftMessageController()));
